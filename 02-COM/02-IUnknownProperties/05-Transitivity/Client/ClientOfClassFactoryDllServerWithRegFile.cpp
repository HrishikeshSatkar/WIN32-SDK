#include <windows.h>
#include "ClassFactoryDllServerWithRegFile_Transitivity.h"
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		if (FAILED(hr))
		{
			MessageBox(hwnd, TEXT("ISumAgain Interface Can Not Be Obtained"), TEXT("Error"), MB_OK);
			DestroyWindow(hwnd);
		}
		...
		{
			MessageBox(hwnd,TEXT("Transitivity Failed!!!"),TEXT("ERROR"),MB_OK);
		}
		pISum->Release();
		pISum = NULL;
		pISumAgain->Release();
