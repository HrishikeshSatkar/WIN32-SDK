...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
		...
		{
			MessageBox(hwnd,TEXT("Both IUnknown Are From Same Component"),TEXT("IDENTITY"),MB_OK);
		}
		else
		{
			MessageBox(hwnd,TEXT("Both IUnknown Are Not From Same Component"),TEXT("IDENTITY"),MB_OK);
		}
		pISum->Release();
		pISum = NULL;
		pISubtract->Release();
